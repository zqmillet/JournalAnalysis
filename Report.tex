...
\input{./Data/ForLaTeX/ProceedingsOfTheIEEE}
...
\input{./Data/ForLaTeX/IEEETransactionOnIndustrialElectronics}
...
\input{./Data/ForLaTeX/IEEETransactionOnIndustrialInformatics}
...
\input{./Data/ForLaTeX/IEEETransactionOnInformationForensicsAndSecurity}
...
\input{./Data/ForLaTeX/SafetyScience}
...
\input{./Data/ForLaTeX/AnnualReviewsInControl}
...
\begin{figure}[H]
  ...
  \begin{tabu}to \textwidth{@{}X[1]*3{X[c, -1]}@{}}
    ...
    \hline
    \input{./Data/ForLaTeX/ReviewTimeSummary}
    \tabucline[1pt]{-}
  \end{tabu}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tabu}to \textwidth{@{}X[1]*3{X[c, -1]}@{}}
    ...
    \multirow{2}{*}{Journal} & \multicolumn{3}{c}{Page Number}\\\cline{2-4}
     & Minimum & Average & Maximum\\ 
    \hline
    \input{./Data/ForLaTeX/PageNumberSummary}
    \tabucline[1pt]{-}
  \end{tabu}
\end{figure}
